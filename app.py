...
from recommendor import hybrid_recommend, get_metadata
from youtubesearchpython import VideosSearch

dataset_url = 'https://www.kaggle.com/datasets/imuhammad/audio-features-and-lyrics-of-spotify-songs'

st.set_page_config(
    page_title='Mosaic - Music Based Recommendation System', 
    page_icon='image.jpg',
    menu_items={
        'Get Help': None,
...
st.title('🎧 Mosaic- Music Based Recommendation System ')
